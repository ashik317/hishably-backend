...
def send_password_reset_email(user):
    try:
        ...
        reset_link = (
            f"{settings.BACKEND_URL}/api/auth/set-password/{uid}/{token}/"
        )
    ...
    <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 40px;">
            ...
            <p style="color: #555; line-height: 1.7;">
                ...
                LandKeeper account associated with
            ...
            <a href="{reset_link}"
               style="color: #2E7D32; word-break: break-all;">
                {reset_link}
            </a>

            <div style="background: #FFF8E1; padding: 14px 18px; margin-top: 24px;">
                <p style="font-size: 13px; color: #7a6200;">
        ...
        <div style="background: #f9f9f9; padding: 24px; text-align: center;">
